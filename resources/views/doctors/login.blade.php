...
@section('titulo', 'Login de Médico')
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-lg-6 mx-auto mb-3">
            <div class="card">
                <div class="card-header">{{ __('Login de Médico') }}</div>
                    ...
                    <form method="POST" action="{{ route('doctors.login') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="mb-3 text-center">
                                ...
                                <!-- @if (Route::has('doctors.password.request'))
                                    <a class="btn btn-link" style="color: #27b8a0;" href="{{ route('doctors.password.request') }}">
                                        {{ __('Esqueseu a senha?') }}
                                    </a>
                                @endif -->
                            </div>
                        ...
                        <div class="form-group row mb-0">
                            <div class="mb-3 text-center">
                                <a class="btn btn-link" style="color: #27b8a0;" href="{{ route('doctors.create') }}">
