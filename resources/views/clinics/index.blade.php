...
@section('titulo', 'Clínicas')

@section('conteudo')
    <br>   
    <form method="GET" action="{{ url('/clinics') }}" accept-charset="UTF-8" class="col-lg-6 mx-auto mb-3" role="search">
    ...
    <table class="table">
        ...
        <tbody> 
            @foreach ($clinics as $clinic)
                <tr>
                    <td><a scope="row" href="{{ route('clinics.show', $clinic) }}">{{ $clinic->nome }}</a></td>
