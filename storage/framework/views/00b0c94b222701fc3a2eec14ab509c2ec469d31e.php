...
<?php $__env->startSection('conteudo'); ?>
    ...
    <form action="<?php echo e(route('patients.update', $patient)); ?>" method="POST">
        ...
        <div class="col-lg-7 mx-auto mb-3">
            ...
            <input type="password" value="<?php echo e($patient->password); ?>" class="form-control" id="password" name="password" placeholder="Digite sua senha:" required>
        </div>
        <div class="col-lg-7 mx-auto mb-3">
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\tcc\resources\views/patients/edit.blade.php ENDPATH**/ ?>