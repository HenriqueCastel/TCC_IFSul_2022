...
<?php $__env->startSection('conteudo'); ?>
    ...
    <form action="<?php echo e(route('doctors.update', $doctor)); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-lg-7 mx-auto mb-3">
            ...
            <input type="password" value="<?php echo e($doctor->senha); ?>" class="form-control" id="senha" name="senha" placeholder="Digite sua senha:" required>
        </div>
        <div class="col-lg-7 mx-auto mb-3">
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\tcc2\resources\views/doctors/edit.blade.php ENDPATH**/ ?>