        ...
        <div class="col-lg-6 mx-auto mb-3">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="<?php echo e(route('patients.password.email')); ?>">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\tcc\resources\views/patients/passwords/email.blade.php ENDPATH**/ ?>