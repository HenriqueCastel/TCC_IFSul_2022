...
<?php $__env->startSection('conteudo'); ?>
    ...
    <form action="<?php echo e(route('clinics.store')); ?>" method="POST">
        ...
        <div class="col-lg-7 mx-auto mb-3">
            ...
            <input type="password" class="form-control" id="senha" name="senha" placeholder="Digite a senha da clínica:" required>
        </div>
        <div class="col-lg-7 mx-auto mb-3">
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\tcc2\resources\views/clinics/create.blade.php ENDPATH**/ ?>